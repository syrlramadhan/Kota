        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="social-icon text-gray-400" aria-label="Facebook">
              ...
              <a href="https://x.com/kotaclouddotcom" className="social-icon text-gray-400" aria-label="X">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zM16.61 20.644h2.039L7.486 3.24H5.397l11.213 17.404z" />
                </svg>
              </a>
              <a href="#" className="social-icon text-gray-400" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="social-icon text-gray-400" aria-label="LinkedIn">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
