      ...
      <div className="container mx-auto px-6 relative z-10 max-w-7xl">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-600 text-lg md:text-xl mt-4 max-w-3xl mx-auto leading-relaxed font-normal">
            The innovators behind Kota Cloud are driving the future of <span className="font-normal" style={{ color: '#46B1CF' }}>connectivity</span> and <span className="font-normal" style={{ color: '#E80035' }}>cloud innovation</span>.
          </p>
